export const Notice_Env_Query = location.origin?.includes('rd.q7link.com') ? "cn-northwest-global" : "hotfix-aws-1-global"; // GQL 查询的环境
export const Notice_Env = location.origin?.includes('rd.q7link.com') ? "cn-northwest-global" : "hotfix-aws-1"; // 传给后端的环境
