            ...
            params.showLink ? (
              <img
                ...
                onClick={(e) => {
                  ...
                  let href = `/onlineSystem/prePublish/${params.data.release_num}/${params.data.branch}/${params.data.release_name}`;
                  if (backlogType) href = `/onlineSystem/releaseOrder/${params.data.release_num}/${params.data.release_name}`;
                  history.push(href);
                }}
              />
            ) : (<div/>)}
