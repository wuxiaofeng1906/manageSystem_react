...
const CodeTableList: React.FC<any> = () => {
  ...
  const showTotalPieChart = (params: any) => {
    const totalChartData: any = [
      ...
      },
      {
        ...
        name: '技术管理人数',
        itemStyle: rendererColorStyle.green,
      },
    ];
              ...
              formatter: () => {
                ...
                const number =
                  (Number(params.Attendance) /
                    (Number(params.Vacation) + Number(params.Attendance))) *
                  100;
  ...
  const getDetailsAndShowChart = async (
    datas: any,
    Range: any,
    domName: string,
    selecteddata: any,
  ...
  const refreshSourceData = async () => {
    const range = getWeekStartAndEndTime(
      choicedConditionForSource.start,
      choicedConditionForSource.end,
    );
    const datas: any = await querySourceData(gqlClient, range, 0);
    gridApiForSource.current?.setRowData(datas);
  };
  ...
  const updateStage = (values: any) => {
    axios
      .post('/api/kpi/analysis/code_multi', values)
      .then(function (res) {
        if (res.data.ok === true) {
          message.info({
            content: '数据保存成功！',
                ...
                <div style={{ width: '100%', height: 45, marginTop: 15, backgroundColor: 'white' }}>
                  <Form.Item>
                    ...
                    <RangePicker
                      ...
                      onChange={onChartTimeSelected}
                      value={[
                        choicedConditionForChart.start === ''
                          ? null
                          : moment(choicedConditionForChart.start),
                        choicedConditionForChart.end === ''
                          ? null
                          : moment(choicedConditionForChart.end),
                      ]}
                    />
                ...
                <Col span={12}>
                  <div style={{ marginTop: 5 }}>
                    ...
                    <div
                      ...
                      style={{ marginTop: '-5', height: 509, width: '100%' }}
                    >
                      <AgGridReact
                    ...
                    >
                      ...
                      <tr style={{ backgroundColor: '#FF9495' }}>
                        ...
                        <td colSpan={2} align={'left'}>
                          {' '}
                          {chartDataForTotal.payAttention}
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td>开发人数</td>
                        <td align={'center'}>
                          <div style={{ width: 30 }}>{chartDataForTotal.Development}</div>
                        </td>
              ...
              <Row>
                <Col span={8}>
                  <div style={{ marginTop: '10px' }}>
                    ...
                    <div
                      className="ag-theme-alpine"
                      style={{ marginTop: '-5', height: 300, width: '100%' }}
                    >
                      <AgGridReact
              ...
              <Row>
                <Col span={8}>
                  <div style={{ marginTop: '10px' }}>
                    ...
                    <div
                      className="ag-theme-alpine"
                      style={{ height: 300, width: '100%', marginTop: '-5px' }}
                    >
                      <AgGridReact
                        columnDefs={getHighesCodeColums('asc')} // 定义列
                        rowData={[]} // 数据绑定
              ...
              <Form.Item>
                ...
                <RangePicker
                  ...
                  value={[
                    ...
                    choicedConditionForSource.end === ''
                      ? null
                      : moment(choicedConditionForSource.end),
                  ]}
                />
              ...
              <Form>
                <div>
                  ...
                  >
                    <Row>
                      <Col span={4}>
                        <Checkbox defaultChecked disabled value="NO.">
                          NO.
                        </Checkbox>
                      </Col>
                      <Col span={4}>
                        <Checkbox defaultChecked disabled value="姓名">
                          姓名
                        </Checkbox>
                      </Col>
                      <Col span={4}>
                    ...
                    <Col>
                      <Form.Item name="attenceCheckbox">
                        <Checkbox
                          ...
                          checked={checkbox.attendenceChecked}
                          onChange={attendenceOnChange}
                        >
                          {' '}
                        </Checkbox>
                      </Form.Item>
                    ...
                    <Col>
                      <Form.Item label="项目阶段:" name="projectStageName">
                        ...
                        >
                          ...
                          <Option key={'developing'} value="developing">
                            {' '}
                            开发{' '}
                          </Option>
