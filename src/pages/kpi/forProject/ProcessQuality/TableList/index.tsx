 ...
 * @LastEditTime: 2021-11-23 17:04:20
 * @LastEditors: jieTan
 * @LastModify:
 */
...
import { HOUR, NUMBER_W, PERCENTAGE } from '@/namespaces';
    ...
    <div className="ag-theme-material" style={{ height: 200 }}>
      ...
      >
        ...
        <AgGridColumn
          ...
          {...doubleNumberW}
        />
        <AgGridColumn headerName="千行Bug率" field="thouslineRatio" valueGetter={EmptyUi}  {...doubleNumberW} />
        <AgGridColumn headerName="单元覆盖率" field="unitCover" valueGetter={EmptyUi}  {...doubleNumberW} />
        <AgGridColumn
        ...
        <AgGridColumn
          ...
          {...doubleNumberW}
        />
        <AgGridColumn headerName="有效Bug率" field="effectiveBugRatio" valueGetter={EmptyUi}  {...ratioW} />
        <AgGridColumn
