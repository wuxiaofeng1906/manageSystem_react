...
const ruleData: IRuleData[] = [
  ...
  },
  {
    ...
    child: [
      ...
      '该开发所有任务的标准工时 = (该开发在该执行所有任务的预计工时 / 该执行的总预计工时) * 该执行的总标准工时，注意：取预计工时时，先检查 "预计工时/消耗工时" >1 或 当执行类型为sprint、hotfix、emergency和stage-patch时，检查‘消耗工时/预计工时’>1.5，则预计工时取 实际消耗,且计算执行预计总工时的时候也要取实际消耗工时;当消耗工时为0的，预计工时则为0;当预计工时为0，且消耗工时>0的，预计工时取消耗工时',
