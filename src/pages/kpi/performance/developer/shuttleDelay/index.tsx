    ...
    table: {
      ...
      dataSource: [
        ...
        },
        {
          ...
          deferredBy: '开发',
          mark:
            '若该需求阶段扭转为’开发完毕‘的时间>当周周三9:30（需求阶段扭转为’开发完毕‘，即该需求最后1个开发类型的任务的完成时间）',
        },
        {
          stage: '开发完',
          rule:
            '且 是否需要测试验证 的值为 "是"，且该需求在该班车中关联的bug状态不等于已关闭（bug为激活/已解决）',
          postpone: '是',
          deferredBy: '开发',
          mark:
            '1.若该bug为激活，该需求归属给指派给的开发；\n2.若该bug为已解决，该需求归属给打解决的开发；\n3.该需求有多个未关闭bug时，该需求要算给多个开发；',
