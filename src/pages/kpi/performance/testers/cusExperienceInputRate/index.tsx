    ...
    <PageContainer>
      ...
      <div>
        <Drawer title={<label style={{"fontWeight": 'bold', fontSize: 20}}>计算规则</label>}
          ...
          <p>2.计算公式：</p>
          <p style={cssIndent}>按人员：测试-用户体验优化投入率 = 该测试人员在该周期完成'性能或体验'需求任务实际工时之和 / 该测试人员在该周期内所有工时之和 * 100；</p>
          <p style={cssIndent}>按部门：测试-用户体验优化投入率 = 该部门所有测试人员在该周期完成'性能或体验'需求任务实际工时求和 / 该部门所有测试人员在该周期内所有工时之和 * 100；</p>
          <p style={cssIndent}>按中心：测试-用户体验优化投入率 = 该中心所有测试人员在该周期完成'性能或体验'需求任务实际工时求和 / 该中心所有测试人员在该周期内所有工时之和 * 100；</p>
