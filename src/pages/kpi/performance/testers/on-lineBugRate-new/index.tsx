...
const TestBugRateTableList: React.FC<any> = () => {
  ...
  const { data, loading } = useRequest(() => queryOnlineBugRate(gqlClient, 'quarter'));
    ...
    <PageContainer>
      ...
      <div>
        ...
        >
          ...
          <p style={cssIndent}>
            按季统计：bug创建日期每季第一个月1号00:00:00--每季第三个月最后1天23:59:59；
          </p>
          <p>1.2 代码量周期（修正后的代码量）</p>
          <p style={cssIndent}>按周统计：代码commit日期为周一00:00:00--周日23:59:59；</p>
          <p style={cssIndent}>
            按月统计：代码commit日期为每月的第一个整周的周一00:00:00--每月最后1个整周的周天23:59:59；
          </p>
          <p style={cssIndent}>
            按季统计：代码commit日期每季第一个月的第一个整周的周一00:00:00--每季第三个月的最后1个整周的周天23:59:59；
          </p>

          <p>
            <strong>2.bug统计范围</strong>
          </p>
          <p style={cssIndent}>
            2.1
            产品为“1.0/1.0正式版--产品经理”“产品实施--实施顾问反馈”“前端平台”“经营会计”“后端平台”“供应链研发”；{' '}
          </p>
          <p style={cssIndent}>2.2 创建者为“顾问”“产品”“客服”； </p>
          <p style={cssIndent}>
            2.3 线上bug统计（按下面条件统计的bug结果要去重）： 统计zt_bug.os in
            ('','onlinecodeerror','Online','online_compatibility') ； 或者统计zt_bug.onlinebugtype
            in
            ...
            或者统计zt_bug.title
            包含'线上存在'or'集群1'or'集群2'or'集群3'or'集群4'or'集群5'or'集群6'or'集群7'
          </p>
          ...
          <p style={cssIndent}>
            2.4 解决方案为“空”“已解决”“延期处理”“后续版本”“转为需求”“代码未合并”的；{' '}
          </p>
          <p style={cssIndent}>
            2.5 统计测试人员查zt_user.address = '测试',
            首先在zt_bug表中判断当前的assignedTo的值是不是测试，
            若是测试则该bug的用户名称则是该测试，若不是测试则在zt_action表中按降序挨个查id
            在zt_history表中的old字段按时间倒序去查测试人员，
            查到的第一个测试人员则该bug的用户名称则是该测试,若old中仍查不到测试人员，则倒序查zt_action.actor的值，查到的第一个测试人员则将
            该bug的用户名称记录为该测试，若还查不到测试人员则名称记录为空。{' '}
          </p>

          <p>
            <strong>二.代码统计</strong>
          </p>
          <Table
            columns={ruleColumns}
          ...
          <p style={{ color: '#1890FF' }}>
            <strong>三.计算公式说明</strong>
          </p>
          <p>
            <strong>1.按人统计（以下人员都特指测试人员）</strong>
          </p>
          <p style={cssIndent}>
            周报：周一至周天测试类线上有效bug求和/(当周周一至周天研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            月报：按月统计bug求和/(按月统计研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            季报：按季统计bug求和/(按季统计研发中心所有开发人员代码量之和/1000)；
          </p>

          <p>
            <strong>2.按组统计</strong>
          </p>
          <p style={cssIndent}>
            周报：该组所有人员周一至周天测试类线上有效bug求和/(当周周一至周天研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            月报：该组所有人员按月统计bug求和/(按月统计研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            季报：该组所有人员按季统计bug求和/(按季统计研发中心所有开发人员代码量之和/1000)；
          </p>

          <p>
            <strong>3.按部门统计</strong>
          </p>
          <p style={cssIndent}>
            周报：该部门所有人员周一至周天测试类线上有效bug求和/(当周周一至周天研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            月报：该部门所有人员按月统计bug求和/(按月统计研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            季报：该部门所有人员按季统计bug求和/(按季统计研发中心所有开发人员代码量之和/1000)；
          </p>

          <p>
            <strong>4.按中心统计 （等于测试部门的周报、月报、季报值）</strong>
          </p>
          <p style={cssIndent}>
            周报：该中心所有测试人员周一至周天测试类线上有效bug求和/(当周周一至周天研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            月报：该中心所有测试人员按月统计bug求和/(按月统计研发中心所有开发人员代码量之和/1000)；
          </p>
          <p style={cssIndent}>
            季报：该中心所有测试人员按季统计bug求和/(按季统计研发中心所有开发人员代码量之和/1000)；
          </p>
        </Drawer>
      </div>
    </PageContainer>
