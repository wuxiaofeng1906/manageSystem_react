...
const ruleData: IRuleData[] = [
  ...
  },
  {
    title: '计算公式',
    child: [
      '按部门：测试-发布引入patch数 = 指派给这个部门开发的需求数 + 由这个部门开发完成的需求数（特殊说明‘指派给这个部门测试的需求数’：不是查需求的指派给，而是查需求关联任务的指派给；当1个需求有多个测试完成任务，给每个测试都算1个需求，若这里的多个测试都属于同一个部门时，需要对需求编号进行去重，注意区分一级部门、2级部门）',
