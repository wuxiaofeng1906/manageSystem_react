...
import { patchTesterServices } from '@/services/statistic';
const ruleData = {
  range: [
  ...
  expression: [
    '不显示按人员（但要存人员的数据：完成任务的需求 和 需求任务指派给测试的）',
...
const Patch: React.FC<any> = () => {
  return <IStaticPerformance ruleData={ruleData} request={patchTesterServices} />;
};
