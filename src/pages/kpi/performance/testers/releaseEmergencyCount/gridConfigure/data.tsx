...
import {converseForAgGrid_showDepts} from "../../testMethod/deptDataAnalyze";
...
export const queryEmergencyCounts = async (client: GqlClient<object>, params: string) => {
  ...
  const {data} = await client.query(`
      {
         devTestReleaseEmergencyDept(kind: "${condition.typeFlag}", ends: ${condition.ends}, identity:TESTER) {
          total{
            dept
            deptName
            kpi
