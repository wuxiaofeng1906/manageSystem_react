...
const ruleData: IRuleData[] = [
  ...
  {
    title: '统计范围',
    child: ['任务完成人为测试；或任务没有完成直接关闭的，关闭人是测试的'],
  },
  {
    title: '计算公式',
    child: [
      '单项任务计划偏差率 = (实际完成或实际关闭时间 - 计划截止 - 法定节假日）/ (计划截止 - 计划开始 + 1 - 法定节假日) *100',
      '按人员：计划偏差率 = AVG(该周期该测试人员所有单项任务计划偏差率)',
      '按部门：计划偏差率 = AVG(该周期该部门所有测试人员所有单项任务计划偏差率)',
      '按中心：计划偏差率 = AVG(该周期该中心所有测试人员所有单项任务计划偏差率)',
    ],
  },
];
const TaskScheduleRate: React.FC<any> = () => {
  return (
    <IStaticPerformance
      ruleData={ruleData}
