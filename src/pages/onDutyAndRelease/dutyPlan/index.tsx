...
const oldDutyTask = {
  personNum: "",
  firstFrontId: "", secondFrontId: "",
  firstBackendId: "", secondBackendId: "",
  firstTesterId: "", secondTesterId: "",
  firstFlowId: "", secondFlowId: "",
  firstSQAId: "", secondSQAId: "",
        ...
        <div style={{height: 700, overflowY: "scroll"}}>
          <Form name="user_form" form={formForPlanModify} layout={'horizontal'} onFinish={submitForm}
            ...
            <Card size="small" title="值班人员" style={{marginTop: -15}} bodyStyle={{height: 350}}>
              ...
              <Row gutter={40} style={{marginTop: -25}}>
                <Col span={10}>
                  <Form.Item name="firstOpenApil" label="openApi" style={{marginTop: 7}}>
                    <Select showSearch>
                      {allUsers.openApi}
                    </Select>
                  </Form.Item>
                ...
                <Col span={14}>
                  <Form.Item name="secondOpenApi" label="openApi第二值班人" style={{marginTop: 7}}>
                    <Select showSearch>
                      {allUsers.openApi}
                    </Select>
                  </Form.Item>
