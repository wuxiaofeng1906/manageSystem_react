...
import {
  ...
  delUpgradeItems,
  addPulishApi,
  confirmUpgradeService,
  dataRepaireReview,
  confirmDataRepairService,
...
import {
  ...
  getAllLockedData,
  getLockedId,
} from './supplementFile/lock/rowLock';
            ...
            <div>
              ...
              <div>
                ...
                <div
                  ...
                  style={{ height: gridHeight.pulishItemGrid, width: '100%' }}
                >
                  <AgGridReact
                ...
                <div
                  className="ag-theme-alpine"
                  style={{ height: gridHeight.upgradeApiGrid, width: '100%' }}
                >
                  <AgGridReact
              ...
              <div>
                ...
                <div
                  className="ag-theme-alpine"
                  style={{ height: gridHeight.upConfirm, width: '100%' }}
                >
                  <AgGridReact
          ...
          <fieldset className={'fieldStyle'}>
            ...
            <div>
              ...
              <div>
                <div
                  className="ag-theme-alpine"
                  style={{ height: gridHeight.dataRepaireReviewGrid, width: '100%' }}
                >
                  <AgGridReact
              ...
              <div>
                ...
                <div
                  className="ag-theme-alpine"
                  style={{ height: gridHeight.reviewConfirm, width: '100%' }}
                >
                  <AgGridReact
            ...
            <div>
              ...
              <div>
                <Spin spinning={executeStatus} tip="执行中...">
                  <div
                    className="ag-theme-alpine"
                    style={{ height: gridHeight.onlineBranchGrid, width: '100%' }}
                  >
                    <AgGridReact
            ...
            <div>
              <div>
                ...
                <div>
                  <div
                    className="ag-theme-alpine"
                    style={{ height: gridHeight.orderList, width: '100%' }}
                  >
                    <AgGridReact
      ...
      >
        <Form>
          <Form.Item name="UiLog" label="UI日志:" style={{ marginTop: -15 }}>
            <a href={`{autoLogModal.url.ui}`} target={'_black'}>
              {autoLogModal.url.ui}
            </a>
          </Form.Item>

          <Form.Item name="interfaceLog" label="接口日志:" style={{ marginTop: -15 }}>
            <a href={`${autoLogModal.url.api}`} target={'_black'}>
              {autoLogModal.url.api}
            </a>
          </Form.Item>
