...
const getStaticMessage = (oraData: any) => {
  ...
  if (!oraData) {
    return (<label style={{marginLeft: 25}}>
      <b>类型统计：</b>共 0 个，bug 0 个，story 0 个，B-story 0 个；
      <b>阶段统计：</b>未开始 0 个，开发中 0 个，开发完 0 个，测试中 0 个，测试完 0 个，已上线 0 个；
  ...
  return (<label style={{marginLeft: 25}}>
    <b>类型统计：</b>共 {bugs + tasks + storys + B_story} 个，bug {bugs} 个，story {storys} 个，B-story {B_story} 个；
    <b>阶段统计：</b>未开始 {oraData?.wait} 个，开发中 {oraData?.devloping} 个，开发完 {oraData?.dev_finished} 个，
