...
const getAllUsers = async (_tech: string) => {
  ...
  await axios
    .get('/api/verify/duty/person', { params: { tech: _tech } })
    .then(function (res) {
...
const getProjectType = async () => {
  ...
  await axios
    .get('/api/verify/duty/project_type')
    .then(function (res) {
      if (res.data.code === 200) {
        projectInfo.data = res.data.data;
      } else {
...
const getPrincipal = async () => {
  ...
  await axios
    .get('/api/verify/duty/project_leader', { params: {} })
    .then(function (res) {
      if (res.data.code === 200) {
...
const getServices = async (branchName: any = {}) => {
  ...
  await axios
    .get('/api/verify/project/server', { params: branchName })
    .then(function (res) {
      if (res.data.code === 200) {
...
const getTestEnv = async () => {
  ...
  await axios
    .get('/api/verify/release/env', { params: {} })
    .then(function (res) {
      if (res.data.code === 200) {
        result.data = res.data.data;
      } else {
